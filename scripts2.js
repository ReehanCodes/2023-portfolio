...
function update() {
    ...
    velocityY += gravity;
     bird.y += velocityY;
    bird.y = Math.max(bird.y + velocityY +2.5 , 0); //apply gravity to current bird.y, limit the bird.y to top of the canvas
    context.drawImage(birdImg, bird.x, bird.y, bird.width, bird.height);
    ...
    if (gameOver) {
        context.fillText("lol u suck", 5, 90);
    }
}
